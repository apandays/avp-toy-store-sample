...
public class RoleCedarTemplates {
    public static final String STORE_MANAGER_ROLE_TEMPLATE_ID = "3LwAFLAyTFTy73CocXUDrd";
    public static final String PACK_ASSOCIATE_ROLE_TEMPLATE_ID = "TS3QzcDzxukJ9tjWsVhdGt";
